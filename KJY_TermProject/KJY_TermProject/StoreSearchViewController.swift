...
class StoreSearchViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource{
    ...
    @IBAction func stopTranscribing(_ sender: Any) {
        ...
        case pickerDataSource[0] : self.pickerView.selectRow(0,    inComponent: 0, animated: true)
            break
        ...
        case "인천광역시" : self.pickerView.selectRow(3,    inComponent: 0, animated: true)
            break
        case "광주광역시" : self.pickerView.selectRow(4,    inComponent: 0, animated: true)
            break
        case "대전광역시" : self.pickerView.selectRow(5,    inComponent: 0, animated: true)
            break
        case "울산광역시" : self.pickerView.selectRow(6,    inComponent: 0, animated: true)
            break
        case "세종특별자치시" : self.pickerView.selectRow(7,    inComponent: 0, animated: true)
            break
        case "경기도" : self.pickerView.selectRow(8,    inComponent: 0, animated: true)
            break
        case "강원도" : self.pickerView.selectRow(9,    inComponent: 0, animated: true)
            break
        case "충청북도" : self.pickerView.selectRow(10,    inComponent: 0, animated: true)
            break
        case "충청남도" : self.pickerView.selectRow(11,    inComponent: 0, animated: true)
            break
        case "전라북도" : self.pickerView.selectRow(12,    inComponent: 0, animated: true)
            break
        case "전라남도" : self.pickerView.selectRow(13,    inComponent: 0, animated: true)
            break
        case "경상북도" : self.pickerView.selectRow(14,    inComponent: 0, animated: true)
            break
        case "경상남도" : self.pickerView.selectRow(15,    inComponent: 0, animated: true)
            break
        case "제주특별자치도" : self.pickerView.selectRow(16,    inComponent: 0, animated: true)
            break
